...
exit_btn.onclick = ()=>{
    info_box.classList.remove("activeInfo");    //info box hide
}
...
function questionCounter(index){
    const button_question_counter = quiz_box.querySelector(".total_question");
    let totalQuestionCountTag = '<span><p>'+ index +'</p>of<p>'+ questions.length +'</p>Question</span>';
    button_question_counter.innerHTML = totalQuestionCountTag;
}
